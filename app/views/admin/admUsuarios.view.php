...
<body>
  ...
  <header class="navbar-adm">
    ...
    <div id="topicos" class="topicos-fechados">
        ...
        <a href="produtos/pesquisa"><img class="icon-nav" src="../../../public/assets/cubo.svg"><br>Produtos</a> 
        <a href="admUsuarios"><img class="icon-nav" src="../../../public/assets/usuario-de-comentarios.svg"><br>Usuários</a>
        <a href="index"><img class="icon-nav" src="../../../public/assets/kisspng-computer-icons-exit-sign-emergency-exit-logo-downl-5b383e15c54734.9298414015304125658081.png"><br>Log-out</a>
    </div>
   </header> 
        ...
        <div class="modal-body">
          <form>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nome" required placeholder="Fulaninho da Silva">
                  </div>
  ...
  <!-- Modal View -->
  <div class="modal fade viewUsuario" id="viewUsuario" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header cabecalho">
        ...
        <div class="modal-body">
          <!-- <form> -->
            ...
            <div class="form-group">
              <label for="input-nome">Nome:</label>
              <input type="text" class="form-control" id="nome" disabled placeholder="Fulaninho da Silva">
            </div>

            <div class="form-group">
              <label for="input-nome" >Email:</label>
              <input type="text" class="form-control" id="nome" disabled placeholder="Fulaninho@gmail.com">
            </div>
  ...
  <!-- Fim Modal view -->
   ...
   <!-- Modal Edit -->
   <div class="modal fade editUsuario" id="editUsuario" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header cabecalho">
  ...
  <!-- Modal delete -->
  <div class="modal fade deleteUsuario" id="deleteUsuario" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header cabecalho">
